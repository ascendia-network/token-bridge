...
use anchor_spl::token_interface::{Burn, MintTo, Transfer};
...
pub fn transfer_native_from_user<'a>(
    ...
    let transfer_ix = transfer(sender_info.key, receiver_info.key, amount);
...
pub fn mint_spl_to_user<'a>(
    ...
    bridge_token: TokenConfig,
        ...
        msg!("mint_spl_to_user, authority_info: {:?}", authority_info.key);
        msg!("mint: {:?}", mint_info);
